...
REMOTE_ANDROID_AUTHORING_PATHS: dict[str, frozenset[str]] = {
    ...
    "/api/v1/projects/{project_id}/cataloging/start": frozenset({"POST"}),
    "/api/v1/projects/{project_id}/cataloging/mobile-commit": frozenset({"POST"}),
    "/api/v1/projects/{project_id}/cataloging/{job_id}/stream": frozenset({"POST"}),
    "/api/v1/projects/{project_id}/cataloging/{job_id}/cancel": frozenset({"POST"}),
    "/api/v1/projects/{project_id}/cataloging/{job_id}": frozenset({"GET"}),
