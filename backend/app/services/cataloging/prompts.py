...
角色抽取要求：
1. 新角色或信息明显不足的旧角色，输出 character_create 或 character_update。
2. 重要角色的 payload 尽量包含：name, role_type, appearance, personality, background, abilities, tone_style, catchphrases, emotion_tendency, custom_system_prompt。
