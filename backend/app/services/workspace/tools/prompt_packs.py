    ...
    workflows = {
        ...
        "writing_no_api": {
            ...
            "steps": [
                ...
                "在下一模型步骤只使用返回的 task_context 一次生成未入库草稿。",
        ...
        "outline_no_api": {
            ...
            "steps": [
                ...
                "调用 prepare_task_context(task_type='outline_planning', arguments={parent_id, insert_after_id, batch_count, requirements}) 建立精简基线。",
                "模型按需调用 search_task_context，复核候选后调用 submit_context_evidence。",
                "在下一模型步骤只使用返回的 task_context 生成章级节点及其 section。",
