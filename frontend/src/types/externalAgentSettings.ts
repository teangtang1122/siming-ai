...
export const PERMISSION_PACKS: PermissionPack[] = [
  {
    ...
    tools: ['list_projects', 'get_project_info', 'search_chapters', 'search_characters', 'search_worldbuilding', 'search_outline', 'search_context', 'prepare_external_writing_context', 'inspect_story_granularity'],
    riskLevel: 'safe',
  },
  {
    ...
    tools: ['create_chapter', 'update_chapter', 'create_character', 'update_character', 'create_outline_node', 'update_outline_node', 'create_worldbuilding_entry', 'update_worldbuilding_entry', 'save_external_chapter_draft', 'archive_chapter_after_write', 'repair_story_granularity', 'apply_external_story_updates'],
    riskLevel: 'medium',
