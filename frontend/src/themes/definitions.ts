...
const wenfang: ThemeDefinition = {
  ...
  config: {
    token: {
      colorPrimary: '#963a36',
      colorSuccess: '#39735d',
      colorSuccessBg: '#edf6f2',
      colorSuccessBorder: '#9dc2b4',
      colorSuccessText: '#2d5f4c',
      colorWarning: '#a66a16',
      colorError: '#b33a36',
      colorErrorBg: '#fff1f0',
      colorErrorBorder: '#d9a5a2',
      colorErrorText: '#8f2926',
      colorInfo: '#315f75',
      colorInfoBg: '#edf5f8',
      colorInfoBorder: '#9bb8c4',
      colorInfoText: '#244e62',
      colorWarningBg: '#fff7e8',
      colorWarningBorder: '#d8ad6f',
      colorWarningText: '#704409',
      colorBgLayout: '#f4f4f1',
      colorBgContainer: '#ffffff',
      colorBgElevated: '#ffffff',
      colorText: '#20201f',
      colorTextSecondary: '#62615e',
      colorTextTertiary: '#73716d',
...
const mobai: ThemeDefinition = {
  ...
  config: {
    token: {
      colorPrimary: '#2a2a2a',
      colorSuccess: '#52c41a',
      colorSuccessBg: '#f0f8eb',
      colorSuccessBorder: '#a9cf96',
      colorSuccessText: '#2f621a',
      colorWarning: '#faad14',
      colorError: '#f5222d',
      colorErrorBg: '#fff1f0',
      colorErrorBorder: '#d9a19f',
      colorErrorText: '#9c1f1b',
      colorInfo: '#2a2a2a',
      colorInfoBg: '#f2f2f2',
      colorInfoBorder: '#b8b8b8',
      colorInfoText: '#222222',
      colorWarningBg: '#fff7e6',
      colorWarningBorder: '#d6a34f',
      colorWarningText: '#6b4200',
...
const qingzhu: ThemeDefinition = {
  ...
  config: {
    token: {
      colorPrimary: '#2d6b4e',
      colorSuccess: '#52c41a',
      colorSuccessBg: '#eaf5ee',
      colorSuccessBorder: '#9ac4a8',
      colorSuccessText: '#245c3c',
      colorWarning: '#d4a843',
      colorError: '#c44a3f',
      colorErrorBg: '#fff1ef',
      colorErrorBorder: '#d9a09a',
      colorErrorText: '#8f3129',
      colorInfo: '#2d6b4e',
      colorInfoBg: '#edf6f1',
      colorInfoBorder: '#9fc4b0',
      colorInfoText: '#24543e',
      colorWarningBg: '#fff8e8',
      colorWarningBorder: '#d1b46d',
      colorWarningText: '#6a4a00',
      colorBgLayout: '#f0f6f2',
      colorBgContainer: '#f8fbf9',
      colorBgElevated: '#f8fbf9',
      colorText: '#1a2e23',
      colorTextSecondary: '#5a7d6a',
      colorTextTertiary: '#60796b',
...
const yedu: ThemeDefinition = {
  ...
  config: {
    ...
    token: {
      colorPrimary: '#d77b72',
      colorSuccess: '#65a98a',
      colorSuccessBg: '#21382f',
      colorSuccessBorder: '#4d806c',
      colorSuccessText: '#b6dfce',
      colorWarning: '#d4a45f',
      colorError: '#e06d67',
      colorErrorBg: '#3b2424',
      colorErrorBorder: '#89504d',
      colorErrorText: '#f1b4b0',
      colorInfo: '#75a9c2',
      colorInfoBg: '#24343b',
      colorInfoBorder: '#4f7e91',
      colorInfoText: '#b9d9e8',
      colorWarningBg: '#3a3020',
      colorWarningBorder: '#8f7040',
      colorWarningText: '#f1d49c',
      colorBgLayout: '#131517',
      colorBgContainer: '#1c1f21',
      colorBgElevated: '#25292c',
      colorText: '#ecebe8',
      colorTextSecondary: '#b2b1ad',
      colorTextTertiary: '#9a9994',
