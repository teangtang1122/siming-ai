...
> **当前源码版本 3.3.10** 修复章节草稿在角色等来源变化后无法保存的问题，并在 PC 正文页、助手草稿卡片和 Android 章节工作区提供明确的“删除草稿”按钮；删除只作用于未保存 AI 草稿，不会删除正式章节。完整变化见 [3.3.10 发布说明](docs/release-notes-3.3.10.md)。
